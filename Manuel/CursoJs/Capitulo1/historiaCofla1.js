dineroCofla = prompt("Cuanto dinero tienes Confla?");
...
if (dineroCofla >= 0.6 && dineroCofla < 1){
    ...
    alert("Cofla, Helado con confitoss o el bote de 1/4 kg");
    alert("y te sobran" + (dineroCofla - 2.9));
}

else{
    alert("Cofla, No te alcanza alv");
}
...
if (dineroRoberto >= 0.6 && dineroRoberto < 1){
    ...
    alert("Roberto, Helado con confitoss o el bote de 1/4 kg")
}

else{
    alert("No te alcanza alv")
}
...
if (dineroPedro >= 0.6 && dineroPedro < 1){
    ...
    alert("Pedro, Helado con confitoss o el bote de 1/4 kg")
}

else{
    alert("Pedro, No te alcanza alv")
}
